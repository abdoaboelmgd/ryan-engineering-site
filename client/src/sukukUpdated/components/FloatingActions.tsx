...
export const FloatingActions: React.FC = () => {
  return (
    <div
      className="fixed bottom-20 lg:bottom-6 left-5 lg:left-6 z-[90] flex flex-col gap-3 items-center"
      id="floating-actions"
    >
      {/* WhatsApp Button */}
      <a
        ...
        className="w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full flex items-center justify-center shadow-xl pulse-wa transition-transform hover:scale-110"
